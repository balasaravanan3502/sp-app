...
class _QueryScreenState extends State<QueryScreen> {
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Container(
          ...
          padding: EdgeInsets.only(right: 8, left: 20, top: 5),
          height: MediaQuery.of(context).size.height * 0.07,
              ...
              onSubmitted: (t) async {
                if (fieldText.text == '') {
                  ...
                  if (subjectchoosen) {
                    print(sub);
                    msg = Message(
                        message: fieldText.text, username: 'ar', subject: sub);
                    // await player
            ...
            child: TextField(
              ...
              onSubmitted: (t) async {
                if (fieldText_1.text == '') {
                  ...
                  text = true;
                  fo_1.requestFocus();
                  ans = Answer(username: 'ar', answer: fieldText_1.text);
                  // await player
                  //     .setAsset('assets/mixkit-message-pop-alert-2354.mp3');
                  fieldText_1.clear();
                  await answeradd();
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        if (fieldText_1.text == '') {
                          ...
                          // player.play();
                          ans =
                              Answer(username: 'ar', answer: fieldText_1.text);
  ...
  Future getanswer(String question, String username) async {
    ques = question;
    user = username;
    print(question);
    ans1.clear();
  ...
  Future searchbysubject(String subject) async {
    ...
    time.clear();
    for (int i = 0; i < msg1.length; i++) {
      if (msg1[i]['type'] == 'q' && msg1[i]['subject'] == 'Toc') {
        print('a');
        print(msg1[i]['subject']);
        que1.add(msg1[i]['message']);
        user2.add(msg1[i]['username']);
        time.add(msg1[i]['time']);
      }
    }
